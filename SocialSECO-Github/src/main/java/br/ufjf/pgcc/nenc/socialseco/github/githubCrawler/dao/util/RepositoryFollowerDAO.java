 ...
 * @author marci
 */
public class RepositoryFollowerDAO {

    private static RepositoryFollowerDAO instance = null;
    private Connection connect = null;
    private Statement statement = null;
    private PreparedStatement preparedStatement = null;
    private ResultSet resultSet = null;

    public static RepositoryFollowerDAO getInstance() {
        if (instance == null) {
            instance = new RepositoryFollowerDAO();
        }
        return instance;
    }

    private RepositoryFollowerDAO() {
    ...
    private void open() {
        try {
            ...
            Logger.getLogger(RepositoryFollowerDAO.class.getName()).log(Level.SEVERE, null, e);
        }
    }
