 ...
 * @author marci
 */
public class RepositoryFollowerService implements CommandService, Runnable {
        ...
        while (true) {
            ...
            try {
                ...
                for (int i = 0; i < json.length(); i++) {
                    ...
                    RepositoryFollowerDAO.getInstance().addCollaborator(new User(id, userName, userType), repo);
                }
                System.gc();
                ...
                try {
                    ...
                    Logger.getLogger(RepositoryFollowerService.class.getName()).log(Level.SEVERE, null, ex1);
                }
            }
